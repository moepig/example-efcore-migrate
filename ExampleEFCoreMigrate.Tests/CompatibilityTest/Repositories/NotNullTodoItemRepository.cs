...
/// </summary>
public class NotNullTodoItemRepository
{
    private readonly NotNullApplicationDbContext _context;

    /// <summary>
    /// コンストラクタ
    /// </summary>
    /// <param name="context">データベースコンテキスト</param>
    public NotNullTodoItemRepository(NotNullApplicationDbContext context)
    {
        _context = context;
    }
