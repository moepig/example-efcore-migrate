...
[TestFixture]
public class NewerApplication_NotNull_DefaultValue_TodoItemRepositoryTest
{
    private MySqlContainer _mysqlContainer;
    private NotNullDefaultValueApplicationDbContext _dbContext;
    private NotNullDefaultValueTodoItemRepository _repository;
    ...
    public async Task OneTimeSetUp()
    {
        ...
        // DbContextの設定 (app)
        var appDbOptions = new DbContextOptionsBuilder<NotNullDefaultValueApplicationDbContext>()
            .UseMySql(_mysqlContainer.GetConnectionString(), new MySqlServerVersion(new Version(8, 0, 43)))
            .Options;
        _dbContext = new NotNullDefaultValueApplicationDbContext(appDbOptions);
        ...
        // リポジトリの初期化
        _repository = new NotNullDefaultValueTodoItemRepository(_dbContext);
    }
